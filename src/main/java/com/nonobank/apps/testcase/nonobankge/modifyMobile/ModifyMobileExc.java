...
public class ModifyMobileExc extends BaseCase{
	...
	public void test(String testcaseName,String testcaseDescription,
		...
		//更换绑定手机号码
		biz_modifyMobile.modifyMobileExc(mobile, password, newMobile, 
				loginPwd_error, newMobile_error, smsCode_error, smsCode2, "设置");
		//退出
