...
public class BankCardExc extends BaseCase{
	...
	public void test(String testcaseName,String testcaseDescription,String environment,String mobile,
			String pictureVerification, String smsCode,String password, String bankName,String bankCardNum, 
			String bankMobile, String bankSmsCode, String bankLimitPrompt,String blackBox,
			String idCard,String realName,String bankName_notBank,String bankCardNum_notBank,
			String bankCardNum_error) {
