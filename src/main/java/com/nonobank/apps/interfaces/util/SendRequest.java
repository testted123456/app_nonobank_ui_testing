...
public class SendRequest {
	...
	// 绝对URL路径----普通get请求
	public static String httpCommonGetByAbsoluteUrl(String url) {
	...
	// 绝对的URL路径----普通post请求
	public static String httpCommonPostByAbsoluteUrl(String url, HashMap<String, String> requsetParams) {
		CloseableHttpClient httpClient = HttpClients.createDefault();
		CloseableHttpResponse response = null;
	...
	// 绝对的URL路径----post json数据
	public static String httpJsonPostByAbsoluteUrl(String url, JSONObject jsonObj) {
		CloseableHttpClient httpClient = HttpClients.createDefault();
		CloseableHttpResponse response = null;
		HttpPost httpPost = new HttpPost(url);
